...
python3 whisper_online_server.py --language zh --min-chunk-size 1 command > output.txt 2> error.txt
python3 whisper_online_server.py --language zh --min-chunk-size 1 > out.txt
...
python3 whisper_online.py  sample_video.wav --language zh --min-chunk-size 1 > out.txt
